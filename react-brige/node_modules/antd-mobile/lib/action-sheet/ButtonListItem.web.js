...
var ButtonListItem = function (_React$Component) {
    ...
    ButtonListItem.prototype.render = function render() {
        var _splitObject = (0, _splitObject4["default"])(this.props, ['children', 'className', 'prefixCls', 'onClick', 'active']);
        ...
        return React.createElement(
            'div',
            (0, _extends3["default"])({}, restProps, { className: touchFeedback ? className + ' ' + prefixCls + '-active' : '' + className, onClick: onClick }),
            children
        );
    };
