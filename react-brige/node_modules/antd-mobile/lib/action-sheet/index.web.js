...
function createActionSheet(flag, config, callback) {
            ...
            case SHARE:
                ...
                children = _react2["default"].createElement(
                    ...
                    _react2["default"].createElement(
                        ...
                        _react2["default"].createElement(
                            _ButtonListItem2["default"],
                            { prefixCls: prefixCls + '-share-cancel-button', className: prefixCls + '-share-cancel-button', onClick: function onClick() {
                                    return cb(-1);
                                } },
                            cancelButtonText
                        )
    ...
    _reactDom2["default"].render(_react2["default"].createElement(
        _rcDialog2["default"],
        { visible: true, title: '', footer: '', prefixCls: prefixCls, className: rootCls, transitionName: transitionName || 'am-slide-up', maskTransitionName: maskTransitionName || 'am-fade', onClose: close, maskClosable: maskClosable, wrapProps: props.wrapProps || {} },
        children
    ), div);
    return {
        close: close
