...
var ImagePicker = function (_React$Component) {
    ...
    ImagePicker.prototype.render = function render() {
        ...
        var onAddImageClick = _props.onAddImageClick;
        ...
        files.forEach(function (image, index) {
            imgItemList.push(_react2["default"].createElement(
                ...
                _react2["default"].createElement('div', { className: prefixCls + '-item-remove', onClick: function onClick() {
                ...
                _react2["default"].createElement(
                    ...
                    _react2["default"].createElement(
                        ...
                        selectable && _react2["default"].createElement(
                            'div',
                            { className: prefixCls + '-item ' + prefixCls + '-upload-btn', style: itemStyle, onClick: function onClick() {
                                    if (onAddImageClick) {
                                        onAddImageClick();
                                    }
                                } },
