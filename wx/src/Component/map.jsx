                    ...
                    margin: '0'
                        ...
                        <div className="menu">
                            ...
                            <div className="journey step">
                                <div className="s-flex-zero s-flex-d s-j-end">

                                    <div>今日里程</div>
                                    <div className="app-w160-h40 step app-margin-t">
                                        <div className="s-flex1 s-j-center">0000</div>
                                    </div>
                                </div>
                                <div className="s-flex-zero app-padding-lr s-s-end">
                                    <div className="app-w200-h60 step">
                                        <div className="s-flex1 s-j-center">0000</div>
                                    </div>
                                </div>
                                <div className="s-flex-zero s-flex-d s-j-end">
                            ...
                            <div className="option step">
                               <div className="s-flex1 s-flex-d">
